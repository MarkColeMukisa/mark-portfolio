        ...
        <div class="grid min-h-14 grid-cols-[auto_minmax(0,1fr)] items-center border-x border-zinc-200 dark:border-zinc-700 sm:grid-cols-[auto_1fr_auto]">
            ...
            <div class="hidden h-full items-center justify-center gap-7 border-e border-zinc-200 px-4 dark:border-zinc-700 sm:flex">
                <a
                    href="{{ route('home') }}"
                    wire:navigate
                    @class([ 'font-mono text-xl font-medium tracking-tight transition-colors' , 'text-zinc-900 dark:text-white'=> request()->routeIs('home'),
                ...
                <a
                    href="/blog"
                    @class([ 'font-mono text-xl font-medium tracking-tight transition-colors' , 'text-zinc-900 dark:text-white'=> request()->is('blog*'),
