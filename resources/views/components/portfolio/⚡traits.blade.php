    ...
    <div class="border-x border-zinc-200 dark:border-zinc-700">
        ...
        <div class="space-y-2 p-4">
            ...
            <div class="flex items-center gap-4 font-mono text-sm text-zinc-900 dark:text-zinc-100">
                ...
                <p class="text-balance">
                    <a class="underline-offset-4 hover:underline" href="tel:+256762063160" target="_blank" rel="noopener noreferrer">
                        +256702262806
                    </a>
                </p>
            </div>
            ...
            <div class="flex items-center gap-4 font-mono text-sm text-zinc-900 dark:text-zinc-100">
                ...
                <p class="text-balance">
                    <a class="underline-offset-4 hover:underline" href="mailto:jb@desishub.com" target="_blank" rel="noopener noreferrer">
